...
public class HookMain implements IXposedHookLoadPackage {
    ...
    private void process_camera2_play() {
        ...
        if (c2_reader_Surfcae != null) {
            ...
            try {
                if (imageReaderFormat == 256) {
                    c2_hw_decode_obj.setSaveFrames(OutputImageFormat.JPEG);
                } else {
        ...
        if (c2_reader_Surfcae_1 != null) {
            ...
            try {
                if (imageReaderFormat == 256) {
                    c2_hw_decode_obj_1.setSaveFrames(OutputImageFormat.JPEG);
                } else {
                    c2_hw_decode_obj_1.setSaveFrames(OutputImageFormat.NV21);
                }
        ...
        if (c2_preview_Surfcae != null) {
            ...
            try {
                c2_player.setOnPreparedListener(mp -> c2_player.start());
        ...
        if (c2_preview_Surfcae_1 != null) {
            ...
            try {
                c2_player_1.setOnPreparedListener(mp -> c2_player_1.start());
    ...
    private void process_a_shot_jpeg(XC_MethodHook.MethodHookParam param) {
        try {
            XposedBridge.log("【VCAM】第二个jpeg:" + param.args[3].toString());
        } catch (Exception eee) {
